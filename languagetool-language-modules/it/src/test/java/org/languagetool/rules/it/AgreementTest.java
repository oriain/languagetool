...
public class AgreementTest {
    ...
    public static List<TestSentence> testSentences = Arrays.asList(
        new TestSentence("test1_VPPS_A_AGREE_incorrect",		"I have explained the lesson and she has followed very carefully.",								"Ho spiegato la lezione e lei ha seguita molto attentamente.",										1),
        new TestSentence("test2_VPPS_A_AGREE_correct",			"I have explained the lesson and she has followed very carefully.",								"Ho spiegato la lezione e lei ha seguito molto attentamente.",										0),
        new TestSentence("test3_VPPS_E_AGREE_incorrect",		"My sons have emigrated.",																			"I miei figli sono emigrato all'estero.",															1),
        new TestSentence("test4_VPPS_E_AGREE_correct",			"My sons have emigrated.",																			"I miei figli sono emigrati all'estero.",															0),
        new TestSentence("test5_VPPS_E_AGREE_incorrect",		"That car cost me an arm and a leg (lit. an eye from my head).",									"Quella macchina mi è costato un occhio della testa.",												1),
        new TestSentence("test6_VPPS_E_AGREE_correct",			"That car cost me an arm and a leg (lit. an eye from my head).",									"Quella macchina mi è costata un occhio della testa.",												0),
        new TestSentence("test7_VPPS_E_AGREE_incorrect",		"St. Peter's square had seemed to her an enchanted kingdom.",										"Piazza San Pietro a lei era sembrato un regno incantato.",											1),
        new TestSentence("test8_VPPS_E_AGREE_correct",			"St. Peter's square had seemed to her an enchanted kingdom.",										"Piazza San Pietro a lei era sembrata un regno incantato.",											0),
        new TestSentence("test9_VPPS_E_AGREE_incorrect",		"The twin girls were born on May 6.",																"Le gemelle erano nato il sei maggio.",																1),
        new TestSentence("test10_VPPS_E_AGREE_correct",		"The twin girls were born on May 6.",																"Le gemelle erano nate il sei maggio.",																0),
        new TestSentence("test11_VPPS_E_AGREE_incorrect",		"Dragons have never existed outside fairy tales.",													"Non sono mai esistito draghi fuori dalle favole.",													1),
        new TestSentence("test12_VPPS_E_AGREE_correct",		"Dragons have never existed outside fairy tales.",													"Non sono mai esistiti draghi fuori dalle favole.",													0),
        new TestSentence("test13_VPPS_E_AGREE_incorrect",		"We liked your poems (lit. Your poems were pleasing to us.) ",										"Ci sono piaciuto le tue poesie.",																	1),
        new TestSentence("test14_VPPS_E_AGREE_correct",		"We liked your poems (lit. Your poems were pleasing to us.)",										"Ci sono piaciute le tue poesie.",																	0),
        new TestSentence("test15_VPPS_A_AGREE_incorrect",		"The bricklayers started at 9 and finished at 3.",													"I muratori hanno cominciati alle otto e finito alle tre.",											1),
        new TestSentence("test16_VPPS_A_AGREE_correct",		"The bricklayers started at 9 and finished at 3.",													"I muratori hanno cominciato alle otto e finito alle tre.",											0),
        new TestSentence("test17_VPPS_E_AGREE_incorrect",		"You had to go away.",																				"Ve ne siete dovuto andare.",																		2),
        new TestSentence("test18_VPPS_E_AGREE_correct",		"You had to go away.",																				"Ve ne siete dovuti andare.",																		0),
        new TestSentence("test19_VPPS_A_AGREE_incorrect",		"You had to go away.",																				"Avete dovuti andarvene.",																			1),
        new TestSentence("test20_VPPS_A_AGREE_correct",		"You had to go away.",																				"Avete dovuto andarvene.",																			0),
        new TestSentence("test21_VPPS_A_AGREE_incorrect",		"All these things were able to be sold at a good price.",											"Tutte queste cose hanno potute essere vendute a buon prezzo.",										1),
        new TestSentence("test22_VPPS_A_AGREE_correct",		"All these things were able to be sold at a good price.",											"Tutte queste cose hanno potuto essere vendute a buon prezzo.",										0),

        new TestSentence("test??_V???_AGREE_incorrect",		"The anger of the Kosovars cannot be channeled into an institutional framework.",					"La rabbia dei Kosovari non può essere incanalato in un ambito istituzionale.",						1),
        new TestSentence("test??_V???_AGREE_correct",			"The anger of the Kosovars cannot be channeled into an institutional framework.",					"La rabbia dei Kosovari non può essere incanalata in un ambito istituzionale.",						0),

        new TestSentence("test23_VPPS_E_AGREE_incorrect",		"When did you get up, girls? ",																	"A che ora vi siete alzato, ragazze?",																2), // Alzato is checked against vi and against ragazze.
        new TestSentence("test24_VPPS_E_AGREE_correct",		"When did you get up, girls?",																		"A che ora vi siete alzate, ragazze?",																0),
        new TestSentence("test25_VPPS_A_AGREE_incorrect",		"Maria bought the skirt.",																			"Maria ha comprata la gonna.",																		1),
        new TestSentence("test26_VPPS_A_AGREE_correct",		"Maria bought the skirt.",																			"Maria ha comprato la gonna.",																		0),
        new TestSentence("test27_VPPS_E_AGREE_incorrect",		"The apples were bought by Luisa.",																"Le mele sono comprato da Luisa.",																	1),
        new TestSentence("test28_VPPS_E_AGREE_correct",		"The apples were bought by Luisa.",																"Le mele sono comprate da Luisa.",																	0),
        new TestSentence("test29_VPPS_E_AGREE_incorrect",		"As soon as we were seated in the room, the film began. (lit. the film was started) ",				"Appena ci siamo seduto in sala, è iniziato il film.",												1),
        new TestSentence("test30_VPPS_E_AGREE_correct",		"As soon as we were seated in the room, the film began. (lit. the film was started)",				"Appena ci siamo seduti in sala, è iniziato il film.",												0),
        ...
        new TestSentence("test43_VPPSA_AGREE6_incorrect",		"My sister and her friend have begun to study Italian.",											"Mia sorella e sua amica hanno cominciate a studiare Italiano.",										1),
        new TestSentence("test44_VPPSA_AGREE6_correct",		"My sister and her friend have begun to study Italian.",											"Mia sorella e sua amica hanno cominciato a studiare Italiano.",										0),
        //new TestSentence("test45_VPPDOP_AGREE6_incorrect",		"Maria cooked the pasta; then Andrew and Paul ate it.",							"Maria ha cotto la pasta; poi Andrea e Paolo l'hanno mangiato.",					1),
        //new TestSentence("test46_VPPDOP_AGREE6_correct",		"Maria cooked the pasta; then Andrew and Paul ate it.",								"Maria ha cotto la pasta; poi Andrea e Paolo l'hanno mangiata.",					0),
        new TestSentence("test45_VPPDOP_AGREE6_incorrect",		"Then Andrew and Paul ate it.",																	"Poi Andrea e Paolo l'hanno mangiato.",																1),
        new TestSentence("test46_VPPDOP_AGREE6_correct",		"Then Andrew and Paul ate it.",																	"Poi Andrea e Paolo l'hanno mangiata.",																0),
        new TestSentence("test47_VPPSE_AGREE12_incorrect",		"My aunt and uncle went to Japan last summer.",													"Mia zia e mio zio sono andato in Giappone la scorsa estate.",										1),
        new TestSentence("test48_VPPSE_AGREE12_correct",		"My aunt and uncle went to Japan last summer.",													"Mia zia e mio zio sono andati in Giappone la scorsa estate.",										0),
        new TestSentence("test49_V2SS_AGREE1_incorrect",		"My aunt and uncle travel a lot.",																	"Mia zia e mio zio viaggia molto.",																	1),
        new TestSentence("test50_V2SS_AGREE1_correct",			"My aunt and uncle travel a lot.",																	"Mia zia e mio zio viaggiano molto.",																0),
        new TestSentence("test51_V2SS_AGREE2_incorrect",		"Rachel and Rebecca are twins.",																	"Rachelle e Rebecca è gemelle.",																		1),
        new TestSentence("test52_V2SS_AGREE2_correct",			"Rachel and Rebecca are twins.",																	"Rachelle e Rebecca sono gemelle.",																	0),
...
//        new TestSentence("test71_ART_PROPER_incorrect",			"The Rome of my youth was very different.",											"La Roma della mia gioventù era molto diversa.",									1),
//        new TestSentence("test72_ART_PROPER_correct",			"The Rome of my youth was very different.",											"Roma della mia gioventù era molto diversa.",					    				0),
...
//        new TestSentence("test151_ART_SUPERL_ADV_incorrect",	"He spoke the most rapidly of all (of anyone).",									"Ha parlato il più rapidamente di tutti.",											1),
...
//        new TestSentence("test153_ART_SUPERL_ADV_incorrect",	"I returned home as soon as possible.",												"Sono tornato a casa più presto possibile.",										1),
...
//        new TestSentence("test158_ART_OMITTED_correct",			"Our dog is always hungry.",														"Il nostro cane sempre ha fame.",													0)
        new TestSentence("test160_VMA1_incorrect",				"Anna was not able to go out.",																	"Anna non è potuto uscire.",																			1),
        new TestSentence("test161_VMA1_correct",				"Anna was not able to go out.",																	"Anna non è potuta uscire.",																			0),
        new TestSentence("test162_VMA2_incorrect",				"I realized that she might do it.",																"Capii che lei avrebbe potuta farlo.",																1),
        new TestSentence("test163_VMA2_correct",				"I realized that she might do it.",																"Capii che lei avrebbe potuto farlo.",																0),
        new TestSentence("test164_VMA3_incorrect",				"She must have put them (her shoes) away before dinner.",											"Lei doveva le aver messo prima di cena.",															1),
        new TestSentence("test165_VMA3_correct",				"She must have put them (her shoes) away before dinner.",											"Lei doveva le aver messe prima di cena.",															0),
        new TestSentence("test166_VMA4_incorrect",				"We should have washed our hands before eating.",													"Ci saremmo dovuto lavare le mani prima di mangiare.",												1),
        new TestSentence("test167_VMA4_correct",				"We should have washed our hands before eating.",													"Ci saremmo dovuti lavare le mani prima di mangiare.",												0),
        new TestSentence("test168_VMA5_incorrect",				"They must have got back before dawn.",															"Devono essere tornato prima dell'alba.",															1),
        new TestSentence("test169_VMA5_correct",				"They must have got back before dawn.",															"Devono essere tornati prima dell'alba.",															0),
        new TestSentence("test170_VMA6_incorrect",				"Carla must have worked a lot.",																	"Carla deve aver lavorata molto.",																	1),
        new TestSentence("test171_VMA6_correct",				"Carla must have worked a lot.",																	"Carla deve aver lavorato molto.",																	0),
        new TestSentence("test172_VMA7_incorrect",				"He must have eaten the whole (pie).",																"Deve l'aver mangiato tutta.",																		1),
        new TestSentence("test173_VMA7_correct",				"He must have eaten the whole (pie).",																"Deve l'aver mangiata tutta.",																		0),
        new TestSentence("test174_VMA8_incorrect",				"Antonia had wanted to be surprised.",																"Antonia aveva voluta essere sorpresa.",																1),
        new TestSentence("test175_VMA8_correct",				"Antonia had wanted to be surprised.",																"Antonia aveva voluto essere sorpresa.",																0),
        new TestSentence("test176_VMA9_incorrect",				"Laura had wanted to have finished her work before going on vacation.",							"Laura aveva voluta aver finito il suo lavoro prima di andare in vacanza.",							1),
        new TestSentence("test177_VMA9_correct",				"Laura had wanted to have finished her work before going on vacation.",							"Laura aveva voluto aver finito il suo lavoro prima di andare in vacanza.",							0),
        new TestSentence("test178_VMA10_incorrect",			"Carla had wanted to have finished it (her sewing) before going to bed.",							"Carla aveva voluto di l'aver finito prima di andare a letto.",										1),
        new TestSentence("test179_VMA10_correct",				"Carla had wanted to have finished it (her sewing) before going to bed.",							"Carla aveva voluto di l'aver finita prima di andare a letto.",										0),
        new TestSentence("test180_VMA11_incorrect",			"It was necessary for Maria to have paid a handsome sum before being admitted to the university.",	"Per Maria, si era dovuto aver pagato una bella somma, prima di essere ammesso al università.",	1),
        new TestSentence("test181_VMA11_correct",				"It was necessary for Maria to have paid a handsome sum before being admitted to the university.",	"Per Maria, si era dovuta aver pagato una bella somma, prima di essere ammesso al università.",	0),
        //new TestSentence("test182_VMP1_incorrect",				"Maria could have been sent to jail.",																		"Maria potrebbe essere stato inviato in prigione.",																			2),
        //new TestSentence("test183_VMP1_correct",					"Maria could have been sent to jail.",																		"Maria potrebbe essere stata inviata in prigione.",																			0),
        new TestSentence("test184_VMP2_incorrect",				"Anna wanted to be excused from school early.",													"Anna era voleva essere esonerato da scuola in anticipo.",											1),
        new TestSentence("test185_VMP2_correct",				"Anna wanted to be excused from school early.",													"Anna era voleva essere esonerata da scuola in anticipo.",											0)
    );
    ...
    public void test9_VPPS_AGREE_incorrect() throws IOException {
        ...
        assertBad("Le gemelle erano nato il sei maggio.");
    ...
    public void test10_VPPS_AGREE_correct() throws IOException {
        // The twin girls were born on May 6.
        assertGood("Le gemelle erano nate il sei maggio.");
    ...
    public void test71_ART_PROPER_incorrect() throws IOException {
        ...
        assertBad("La Roma della mia gioventù era molto diversa.");
    }

    @Test
    public void test72_ART_PROPER_correct() throws IOException {
        // The Rome of my youth was very different.
        assertGood("Roma della mia gioventù era molto diversa.");
    }
...
/*    @Test
    ...
    public void test153_ART_SUPERL_ADV_incorrect() throws IOException {
        ...
        assertBad("Sono tornato a casa più presto possibile.");
    }
