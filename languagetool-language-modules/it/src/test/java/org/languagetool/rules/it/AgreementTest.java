...
public class AgreementTest {
    ...
    public static List<TestSentence> testSentences = Arrays.asList(
        ...
        new TestSentence("test8_VPPS_AGREE_correct",			"St. Peter's square had seemed to her an enchanted kingdom.",						"Piazza San Pietro a lei era sembrata un regno incantato.",							0),
        new TestSentence("test9_VPPS_AGREE_incorrect",			"The twin girls were born on May 6.",												"Le gemelle erano nato il sei maggio.",												1),
        new TestSentence("test10_VPPS_AGREE_correct",			"The twin girls were born on May 6.",												"Le gemelle erano nate il sei maggio.",												0),
        ...
        new TestSentence("test17_VPPS_AGREE_incorrect",			"You had to go away.",																"Ve ne siete dovuto andare.",														2),
        ...
        new TestSentence("test52_V2SS_AGREE2_correct",			"Rachel and Rebecca are twins.",													"Rachele e Rebecca sono gemelle.",													0),
